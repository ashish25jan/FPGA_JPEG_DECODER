...
//from 2 to 4
#define MB2_FIFO_WC_S1  	  (int*)(mb2_cmemout0_BASEADDR+2*sizeof(int)+2*sizeof(struct from2_to_3))
#define MB2_FIFO_RWC_S1 	  (int*)(mb4_cmemin0_pt_REMOTEADDR)
#define MB2_FIFO_RC_S1  	  (int*)(mb2_cmemin0_BASEADDR+2*sizeof(int)+2*sizeof(struct from1_to_2))
#define MB2_FIFO_RRC_S1  	  (int*)(NULL)
#define MB2_FIFO_BUFFER_S1   (int*)(mb2_cmemout0_BASEADDR+3*sizeof(int)+2*sizeof(struct from2_to_3))
#define MB2_FIFO_RBUFFER_S1  (int*)(mb4_cmemin0_pt_REMOTEADDR+sizeof(int))


#define MB4_FIFO_WC  	 (int*)(mb4_cmemin0_BASEADDR)
#define MB4_FIFO_RWC 	 (int*)(NULL)
#define MB4_FIFO_RC  	 (int*)(mb4_cmemout0_BASEADDR)
#define MB4_FIFO_RRC 	 (int*)(mb2_cmemin0_pt_REMOTEADDR+2*sizeof(int)+2*sizeof(struct from1_to_2))
#define MB4_FIFO_BUFFER  (int*)(mb4_cmemin0_BASEADDR+sizeof(int))
